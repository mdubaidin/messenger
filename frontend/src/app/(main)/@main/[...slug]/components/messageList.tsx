...
// import { setContact } from '@/store/features/contact/contactSlice';
...
const MessageList = () => {
    const { anchorEl: anchorElEmoji, openMenu: openEmojiMenu, closeMenu: closeEmojiMenu } = useMenu();
    const { anchorEl: anchorElAction, openMenu: openActionMenu, closeMenu: closeActionMenu } = useMenu();
        ...
        >
            ...
            <Menu
                ...
                <MenuItem
                    ...
                    <ListItemText primaryTypographyProps={{ fontSize: 14, color: 'text.secondary' }}>Reply</ListItemText>
                </MenuItem>
                <MenuItem
                    ...
                    <ListItemText primaryTypographyProps={{ fontSize: 14, color: 'text.secondary' }}>React</ListItemText>
                </MenuItem>
                <MenuItem
                // onClick={() => {
                //     setSelectedMessage({
                ...
                // }}
                >
                    <ListItemText primaryTypographyProps={{ fontSize: 14, color: 'text.secondary' }}>
